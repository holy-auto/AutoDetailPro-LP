...
export default function ProRecruit() {
  return (
    <section id="pro-recruit" className="relative py-20 sm:py-32 bg-[#0a2540] text-white overflow-hidden">
      <div className="absolute inset-0 dot-grid opacity-40 pointer-events-none" />
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-[#00b4ff] rounded-full opacity-15 blur-3xl pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="heading-tight text-4xl sm:text-5xl lg:text-6xl font-black mb-5">
              洗車・コーティングの
              <br />
              <span className="text-[#00b4ff]">プロ</span>、募集中。
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {benefits.map((b) => (
                <div
                  key={b.title}
                  className="bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-[#00b4ff] transition-colors"
                >
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              <div className="bg-[#00b4ff] text-[#0a2540] rounded-3xl p-8 lg:p-10 rotate-1">
                ...
                <p className="text-xs text-[#0a2540]/70 mb-6">
                  ※ 週4日 / 1日3件稼働 / 平均単価12,000円の場合
                </p>
                <div className="space-y-2 text-sm border-t-2 border-[#0a2540] pt-5">
              ...
              <div className="absolute -top-4 -left-4 bg-[#0a2540] text-[#00b4ff] px-4 py-3 rounded-full rotate-[-6deg] shadow-xl">
