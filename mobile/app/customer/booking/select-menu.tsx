...
// NOTE: id は UUID 形式にする (orders.menu_ids が UUID[] のため)。
// 本番では Supabase の menus テーブルから fetch する想定。
const MOCK_PRO_MENUS = [
  { id: '11111111-1111-4111-8111-111111111111', name: '手洗い洗車', price: 3000, duration: '30分', categoryId: 'exterior' },
  { id: '22222222-2222-4222-8222-222222222222', name: 'プレミアム洗車', price: 5000, duration: '45分', categoryId: 'exterior' },
  { id: '33333333-3333-4333-8333-333333333333', name: 'ガラスコーティング', price: 15000, duration: '120分', categoryId: 'coating' },
  { id: '44444444-4444-4444-8444-444444444444', name: '室内クリーニング', price: 4500, duration: '40分', categoryId: 'interior' },
];
